...
const RenderCards = ({data,title}) => {      //react functional component
  if(data?.length > 0 ){
...
const Home = () => {
  ...
  const fetchPosts = async () => {
    ...
    try {
      const response = await fetch('//localhost:8080/api/v1/post', {
        method: 'GET',
        headers: {
  ...
  return (
   <section className='max-w-7xl mx-auto'>
    <div>
    <p className='font-extrabold text-[50px] text-[#EA8D8D]'>Ima<span className='font-extrabold text-[50px] text-[#A890FE]'>gic</span></p> 
    </div>
    <div>
      <h3 className='font-extrabold text-[25px]'>The Community Showcase</h3>
