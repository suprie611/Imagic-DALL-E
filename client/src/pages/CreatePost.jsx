...
import { preview,temp } from '../assets';
 ...
 return(
  <section className='max-w-7xl mx-auto '>
    ...
    <div>
      ...
      <img src={temp} alt="AI" className='h-40 w-85 mt-5 '  />
      ...
      type='button'
       onClick={() => {
        if(form.photo){
          ...
          alert("Please Generate an image to download !")
        }
       }}
        className='mt-3  text-white bg-[#ED2939]
        font-medium  rounded-md   text-sm w-full sm:ml-3 sm:w-auto px-5 py-2.5 text-center'
        >
         Download
        </button>
